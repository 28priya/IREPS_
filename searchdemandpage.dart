...
class _SearchDemandsScreenState extends State<SearchDemandsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildStatusDropdown() {
    // IMPROVED: Remove card and make dropdown cover full width
    return Container(
      width: double.infinity,
      ...
      child: Row(
        children: [
          // Add padding on left side to position icon
          Padding(
            padding: const EdgeInsets.only(left: 16),
            child: Icon(Icons.list, color: Colors.blue.shade800, size: 20),
          ),
          ...
          Expanded(
            child: Theme(
              ...
              child: DropdownButtonHideUnderline(
                child: ButtonTheme(
                  alignedDropdown: true, // This aligns dropdown menu with button
                  child: DropdownButton<String>(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    menuMaxHeight: 300,
                    // Added to ensure dropdown is as wide as the parent
                    itemHeight: 48,
                    underline: Container(), // Remove the underline
                    // Padding to give space between icon and text
                    ...
                    items: statusLabels.entries.map<DropdownMenuItem<String>>((entry) {
                      return DropdownMenuItem<String>(
                        value: entry.key,
                        // Remove padding here and let the button handle it
                        child: Text(
                          entry.value,
  ...
  Widget _buildDropdown({
    ...
    // IMPROVED: Remake department dropdown to match status dropdown style
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
        color: Colors.white,
